#!/usr/bin/env python
# NOTE: patched to look for cfg via bosh release
# * cfg - /var/vcap/jobs/serverdensity-agent/config/sd-agent.cfg
# * log - /var/vcap/sys/tmp/serverdensity-agent/
'''
	Server Density
...
try:
	...
	if os.path.exists('/var/vcap/jobs/serverdensity-agent/config/sd-agent.cfg'):
		configPath = '/var/vcap/jobs/serverdensity-agent/config/sd-agent.cfg'
	else:
	...
	else if os.path.exists('/var/vcap/sys/tmp/serverdensity-agent/'):
		agentConfig['tmpDirectory'] = '/var/vcap/sys/tmp/serverdensity-agent/'
	else:
